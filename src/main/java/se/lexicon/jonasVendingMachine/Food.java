...
public class Food extends ProductAbstract{
    ...
    private String item1[]; // = {"4", "25", "1200kc Pizza", "Pizza"};
    private String item2[]; // = {"5", "35", "1500kc Korvstroganoff", "Korvstroganoff"};
    private String item3[]; // = {"6", "30", "1400kc Bolognese", "Bolognese"};
    ...
    @Override
    public void setItem1(String[] item4) {
        this.item1 = item4;
    }
    ...
    @Override
    public void setItem2(String[] item5) {
        this.item2 = item5;
    }
    ...
    @Override
    public void setItem3(String[] item6) {
        this.item3 = item6;
    }
