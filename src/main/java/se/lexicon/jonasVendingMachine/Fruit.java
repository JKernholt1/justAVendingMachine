...
public class Fruit extends ProductAbstract {

    private String item1[]; // = {"7", "5", "1% fat Apple", "Apple"};
    private String item2[]; // = {"8", "6", "2% fat Orange", "Orange"};
    private String item3[]; // = {"9", "4", "3% fat Kiwi", "Kiwi"};
    ...
    @Override
    public void setItem1(String[] item7) {
        this.item1 = item7;
    }
    ...
    @Override
    public void setItem2(String[] item8) {
        this.item2 = item8;
    }
    ...
    @Override
    public void setItem3(String[] item9) {
        this.item3 = item9;
    }
